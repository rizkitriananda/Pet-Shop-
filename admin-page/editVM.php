...
$data = query("SELECT * FROM `obat_vitamin` WHERE id = $id")[0];
...
<html lang="en" class="scroll-smooth">
  ...
  <body class="font-poppins bg-[#efefef]">
    <header>
      <nav class="flex justify-between bg-[#ffffff] bg-transparent fixed top-0 left-0 right-0 z-[100] border-b py-3 border-[#dadadd]">
      ...
      <section class="mt-[80px] px-3 mx-auto flex flex-col justify-center">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="bg-[#fefefe] w-[500px] p-7 rounded-lg flex flex-col">
          ...
          <div class="h-[50px] flex items-center justify-between mb-3 relative overflow-hidden">
            ...
            <img src="../image/VM/<?= $data['gambar']; ?>" alt="" class="w-[50px] absolute left-[85px]" />
          ...
          <div class="flex justify-between mb-3">
            ...
            <textarea name="nama" id=""  cols="30" rows="10" class="rounded w-[250px] px-2 focus:outline-[#830FF3] resize-none border border-[#777]"><?= $data['nama']; ?></textarea>
          </div>
